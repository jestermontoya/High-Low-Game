...
int score = 0;
String cardBack = "assets/img/back.png";
int card1 = Random().nextInt(52) + 1;
List<String> updateCard = [
  "assets/img/$card1.png",
  cardBack, cardBack, cardBack, cardBack
];
int gNumberCard = Random().nextInt(52) + 1;
String gCard = "assets/img/$gNumberCard.png";
bool isBack = true;
String ans = "";
